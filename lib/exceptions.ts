...
export class RequestError extends Error {
  constructor(message: string, public code: string, public detailErrorMessage: string, private originalError: Error) {
    super(message);
  }
...
class InvalidTxResultJsonFormatException extends Error {
  constructor(input: string, readonly cause?: Error) {
