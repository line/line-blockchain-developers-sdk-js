...
export class RawTransactionLog {
  constructor(readonly msgIndex: number, readonly log: string = "", readonly events: Array<RawTransactionEvent>) {}
}
...
export class RawTransactionEvent {
  constructor(readonly type: string, readonly attributes: Array<RawTransactionEventAttribute>) {}
}
...
export class RawTransactionEventUtil {
  ...
  public static findAttributeOrNull(rawTransactionEvent: RawTransactionEvent, attributeType: EventAttributeType) {
  ...
  public static attributesExclude(
    event: RawTransactionEvent,
    ...eventTypesToExclude: EventAttributeType[]
...
export class RawTransactionRequest {
  constructor(readonly type: string, readonly value: RawTransactionRequestValue) {}
}
...
export class RawTxSignature {
  constructor(readonly pubKey: RawTransactionRequestPubKey, readonly signature: string) {}
}
...
export class RawTransactionRequestFee {
  constructor(readonly gas: number = 0, readonly amount: Array<RawTransactionRequestAmount> = []) {}
}

export class RawTransactionRequestAmount {
  constructor(readonly denomination?: string, readonly amount?: string) {}
}
