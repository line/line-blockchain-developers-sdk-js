...
const tx_result_util_1 = require("../lib/tx-result-util");
const test_data_1 = require("./test-data");
(0, mocha_1.describe)("tx-result-util test with tx message", () => {
    const singleTransactionResultResponse = test_data_1.singleTransactionResult.responseData;
    ...
    //   });
    (0, mocha_1.it)("given service-token-burn-from message, find contractId", () => {
        const senderWalletAddress = tx_result_util_1.TxResultUtil.findContractId(test_data_1.serviceTokenBurnFromTxResult);
        (0, chai_1.expect)("678c146a").to.equal(senderWalletAddress);
    });
});
