...
describe("LbdTxEventConverterV1 tests", () => {
  ...
  it("test emptyMsgCreated", () => {
    let memoRawTxResultEvent = new RawTransactionEvent("message", [
  ...
  it("test accountCreated", () => {
    let createAccountRawTxResultEvent = new RawTransactionEvent("create_account", [
  ...
  it("test coinTransferred", () => {
    let coinTransferredRawTxResultEvent = new RawTransactionEvent("transfer", [
      new RawTransactionEventAttribute("sender", "tlink1fr9mpexk5yq3hu6jc0npajfsa0x7tl427fuveq"),
  ...
  it("test tokenIssued", () => {
    let tokenIssuedRawTxResultEvent = new RawTransactionEvent("issue", [
  ...
  it("test tokenMinted", () => {
    let tokenMintedRawTxResultEvent = new RawTransactionEvent("mint", [
  ...
  it("test tokenBurned", () => {
    let tokenMintedRawTxResultEvent = new RawTransactionEvent("burn", [
      new RawTransactionEventAttribute("contract_id", "9be17165"),
    ...
    let expectedValue = new EventTokenBurned(0, "9be17165", "1000", "tlink1xrr7amq5g80afllmfcud59y3w60q58llx2zpe9");
    expect(expectedValue).to.deep.equal(actualValue);
  });
  ...
  it("test tokenModified", () => {
    let tokenMintedRawTxResultEvent = new RawTransactionEvent("modify_token", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
      new RawTransactionEventAttribute("name", "STname"),
      new RawTransactionEventAttribute("meta", "meta"),
    ]);

    let emptyMessageEvent = new RawTransactionEvent("message", [
    ...
    let expectedValue = new EventTokenModified(0, "9636a07e", "tlink1fr9mpexk5yq3hu6jc0npajfsa0x7tl427fuveq", [
  ...
  it("test tokenTransferred", () => {
    let tokenTransferredRawTxResultEvent = new RawTransactionEvent("transfer", [
      new RawTransactionEventAttribute("from", "tlink1fr9mpexk5yq3hu6jc0npajfsa0x7tl427fuveq"),
      new RawTransactionEventAttribute("to", "tlink1nf5uhdmtsshmkqvlmq45kn4q9atnkx4l3u4rww"),
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
      new RawTransactionEventAttribute("amount", "1000"),
  ...
  it("test collectionCreated", () => {
    let collectionCreatedRawTxResultEvent = new RawTransactionEvent("create_collection", [
    ...
    let permissionGrantedRawTxResultEvent = new RawTransactionEvent("grant_perm", [
  ...
  it("test collectionFtBurned", () => {
    let collectionCreatedRawTxResultEvent = new RawTransactionEvent("burn_ft", [
  ...
  it("test collectionFtIssued", () => {
    let collectionFtIssuedRawTxResultEvent = new RawTransactionEvent("issue_ft", [
  ...
  it("test collectionFtMinted", () => {
    let collectionFtMintedRawTxResultEvent = new RawTransactionEvent("mint_ft", [
  ...
  it("test collectionFtModified", () => {
    let collectionFtModifiedRawTxResultEvent = new RawTransactionEvent("modify_token", [
      new RawTransactionEventAttribute("contract_id", "61e14383"),
      new RawTransactionEventAttribute("name", "TestFT"),
      new RawTransactionEventAttribute("token_id", "0000003100000000"),
    ]);
  ...
  it("test collectionNftTypeModified", () => {
    let collectionNftTypeModifiedRawTxResultEvent = new RawTransactionEvent("modify_token", [
      new RawTransactionEventAttribute("contract_id", "61e14383"),
      new RawTransactionEventAttribute("name", "TestFT"),
  ...
  it("test collectionNftModified", () => {
    let collectionNftModifiedRawTxResultEvent = new RawTransactionEvent("modify_token", [
      new RawTransactionEventAttribute("contract_id", "61e14383"),
      new RawTransactionEventAttribute("name", "TestFT"),
      new RawTransactionEventAttribute("token_id", "1000003100000001"),
    ]);
  ...
  it("test collectionFtTransferred", () => {
    let tokenTransferredRawTxResultEvent = new RawTransactionEvent("transfer_ft", [
      new RawTransactionEventAttribute("from", "tlink1fr9mpexk5yq3hu6jc0npajfsa0x7tl427fuveq"),
      new RawTransactionEventAttribute("to", "tlink1nf5uhdmtsshmkqvlmq45kn4q9atnkx4l3u4rww"),
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
  ...
  it("test collectionModified with modify_collection", () => {
    let collectionModifiedRawTxResultEvent = new RawTransactionEvent("modify_collection", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
  ...
  it("test collectionModified with modify fungible token", () => {
    let collectionModifiedRawTxResultEvent = new RawTransactionEvent("modify_token", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
      new RawTransactionEventAttribute("name", "TestFT"),
  ...
  it("test collectionModified with modify non-fungible token type ", () => {
    let collectionModifiedRawTxResultEvent = new RawTransactionEvent("modify_token_type", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
  ...
  it("test collectionNftBurned", () => {
    let collectionNftBurnedRawTxResultEvent = new RawTransactionEvent("burn_nft", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
      new RawTransactionEventAttribute("from", "tlink1fr9mpexk5yq3hu6jc0npajfsa0x7tl427fuveq"),
      new RawTransactionEventAttribute("token_id", "1000000100000001"),
    ]);

    let operationBurnNftRawTxResultEvent = new RawTransactionEvent("operation_burn_nft", [
      new RawTransactionEventAttribute("token_id", "1000000100000001"),
    ]);
  ...
  it("test collectionNftAttached", () => {
    let collectionNftAttachedRawTxResultEvent = new RawTransactionEvent("attach", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
      new RawTransactionEventAttribute("from", "tlink1fr9mpexk5yq3hu6jc0npajfsa0x7tl427fuveq"),
  ...
  it("test collectionNftDetached", () => {
    let collectionNftDetachedRawTxResultEvent = new RawTransactionEvent("detach", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
      new RawTransactionEventAttribute("from", "tlink1fr9mpexk5yq3hu6jc0npajfsa0x7tl427fuveq"),
      new RawTransactionEventAttribute("token_id", "1000000100000003"),
  ...
  it("test collectionNftHolderChanged", () => {
    let collectionNftTransferredRawTxResultEvent = new RawTransactionEvent("transfer_nft", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
      new RawTransactionEventAttribute("from", "tlink1fr9mpexk5yq3hu6jc0npajfsa0x7tl427fuveq"),
    ...
    let collectionOperationNftTransferredRawTxResultEvent = new RawTransactionEvent("operation_transfer_nft", [
      new RawTransactionEventAttribute("token_id", "1000000100000003"),
    ]);
  ...
  it("test collectionNftIssued", () => {
    let collectionNftIssuedRawTxResultEvent = new RawTransactionEvent("issue_nft", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
      new RawTransactionEventAttribute("token_type", "10000001"),
    ]);
  ...
  it("test collectionNftMinted", () => {
    let collectionNftMintedRawTxResultEvent = new RawTransactionEvent("mint_nft", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
      new RawTransactionEventAttribute("token_id", "1000000100000003"),
      new RawTransactionEventAttribute("from", "tlink1fr9mpexk5yq3hu6jc0npajfsa0x7tl427fuveq"),
  ...
  it("test collectionNftRootChanged with detach", () => {
    let collectionNftAttachedRawTxResultEvent = new RawTransactionEvent("detach", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
      new RawTransactionEventAttribute("from", "tlink1fr9mpexk5yq3hu6jc0npajfsa0x7tl427fuveq"),
      new RawTransactionEventAttribute("proxy", "tlink1xrr7amq5g80afllmfcud59y3w60q58llx2zpe8"),
      new RawTransactionEventAttribute("token_id", "1000000100000003"),
    ...
    let collectionNftRootChangedRawTxResultEvent = new RawTransactionEvent("detach", [
      new RawTransactionEventAttribute("token_id", "1000000100000003"),
    ]);
  ...
  it("test collectionNftTransferred", () => {
    let collectionNftTransferredRawTxResultEvent = new RawTransactionEvent("transfer_nft_from", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
      new RawTransactionEventAttribute("from", "tlink1fr9mpexk5yq3hu6jc0npajfsa0x7tl427fuveq"),
  ...
  it("test collectionProxyApproved from batch", () => {
    let collectionProxyApprovedRawTxResultEvent = new RawTransactionEvent("approve_collection", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
  ...
  it("test collectionProxyDisapproved from batch", () => {
    let collectionProxyDisapprovedRawTxResultEvent = new RawTransactionEvent("disapprove_collection", [
      new RawTransactionEventAttribute("contract_id", "9636a07e"),
      new RawTransactionEventAttribute("approver", "tlink1fr9mpexk5yq3hu6jc0npajfsa0x7tl427fuveq"),
      new RawTransactionEventAttribute("proxy", "tlink137pmnn2snxdcwa5kmg5rra6u3tf2y5c7emmm7p"),
    ]);
