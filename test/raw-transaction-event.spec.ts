...
describe("RawTransactionEvent test", () => {
  it("test findAttributeNotNull with unknown eventAttributeType", () => {
    ...
    let rawTransactionEvent = new RawTransactionEvent("test-type", attributes);
    ...
    let actualValue = RawTransactionEventUtil.findAttributeNotNull(
      rawTransactionEvent,
  ...
  it("test findAttributeNotNull with from eventAttributeType", () => {
    ...
    let rawTransactionEvent = new RawTransactionEvent("from", attributes);
  ...
  it("test findAttributeNotNull with approver eventAttributeType", () => {
    ...
    let rawTransactionEvent = new RawTransactionEvent("approver", attributes);
