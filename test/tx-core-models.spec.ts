...
describe("core tx model tests", () => {
    it("build core models", () => {
        ...
        let expectedTxResultJson = '{"summary":{"height":0,"txIndex":0,"txHash":"D3833E2CED77A11639D03EC3DF4B0EC9B77EBFF48795B7151D5201439738031A","signers":[{"address":"tlink145knu8tlpjmx9gsf0dxxfdcr68a4sapv5x6tk7"}],"result":{"code":0,"codeSpance":"","result":0}},"txMessages":[{"msgIndex":0,"requestType":"test","details":{"key":"test","value":"test value"}}],"txEvents":[{"eventName":"TestEvent"}]}';
